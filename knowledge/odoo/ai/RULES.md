---
name: odoo-ai-rules
description: Reglas maestras de desarrollo Odoo para proyectos Alesco Perú. Se leen SIEMPRE antes que cualquier plugin.
license: LGPL-3
metadata:
  author: Geraldow
  org: Alesco-Peru
...
# Propietario: Geraldo Jaramillo (Geraldow) / Alesco Perú SAC
...
## R3 — Verificación de identidad antes de commit/push (Alesco Perú)

Antes de `git commit` o `git push` en cualquier proyecto Alesco:
...
Cruzar contra contribuidores autorizados en:
...
Proyectos en scope: `aeca`, `gprinter`, `conservial`, `omnia`, `benest`, `intiflow`
...
| R5 pre-migrate | Descubierto en conservial `purchase_report_imports` v18.0.1.4 | 2026-05-20 |
| R8 sequence_preview con id | Bug breadcrumb vs H1 en conservial | 2026-05-20 |
| R3 identidad Alesco | CONTRIBUTING.md Alesco Perú | 2026-05-15 |
