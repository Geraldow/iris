...
<!-- Purpose: Write specifications with requirements and scenarios (delta specs for changes) -->
...
4. **Execute Phase Objective**: 
   ...
   - Define clear test scenarios, acceptance criteria, and edge cases.
5. **Validation**: Check your specs against `{instruction}`. Ensure it covers all requirements for `{phase}`.
6. **Save to Engram**: Save your finalized specs to Engram. You MUST use exactly this topic key: `sdd/{change}/{phase}`. Include standard type and project fields.
